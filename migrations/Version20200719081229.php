 ...
 */
final class Version20200719081229 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE article CHANGE is_published is_published TINYINT(1) DEFAULT \'1\' NOT NULL');
    }
}
